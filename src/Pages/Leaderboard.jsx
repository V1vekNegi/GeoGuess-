...
export default function Leaderboard() {
  ...
  return (
    ...
    style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="relative bg-gradient-to-br from-white/20 to-white/2 backdrop-blur-md border border-white/30 p-5 w-1/2 h-[70%] rounded-xl shadow-lg">
         

      {leaderboard.length > 2 && (
        <div className="flex justify-center gap-12 items-end mb-12">
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 bg-pink-500 rounded-full mb-2"><img className="hover:scale-105 transition-all duration-300" src={`/avatars/panda.png`} alt="" /></div>
            <p>2nd</p>
          ...
          <div className="flex flex-col items-center">
            <div className="w-24 h-24 bg-pink-500 rounded-full mb-2 border-4 border-yellow-300"><img className="hover:scale-105 transition-all duration-300" src={`/avatars/jaguar.png`} alt="" /></div>
          ...
          <div className="flex flex-col items-center ">
            <div className="w-20 h-20 bg-pink-500 rounded-full mb-2"><img className="hover:scale-105 transition-all duration-300" src={`/avatars/deer.png`} alt="" /></div>
            <p>3rd</p>
      ...
      <div className="grid gap-3 grid-cols-[repeat(auto-fit,_minmax(16rem,_1fr))] w-full">
        {leaderboard.slice(3).map((player, index) => (
          <div
            key={player.username}
            className=" group flex items-center justify-center gap-8 bg-purple-800 px-4 py-2 shadow-2xl rounded-lg w-full hover:scale-105 transition-all duration-300"
          >
